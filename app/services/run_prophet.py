...
def run() -> None:
    """Run the Prophet forecasting validation workflow end-to-end."""
    data_path = PROJECT_ROOT / "data" / "processed" / "processed_timeseries.csv"
    model_path = PROJECT_ROOT / "trained_models" / "prophet_texas_beverages.pkl"
    ...
    try:
        ...
        logger.exception("Prophet pipeline failed")
        raise error
