...
def run() -> None:
    """Run the SARIMA forecasting validation workflow end-to-end."""
    data_path = PROJECT_ROOT / "data" / "processed" / "processed_timeseries.csv"
    model_path = PROJECT_ROOT / "trained_models" / "sarima_texas_beverages.pkl"
    ...
    try:
        ...
        logger.exception("SARIMA pipeline failed")
        raise error
